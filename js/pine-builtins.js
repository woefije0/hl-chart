...
const TOP_LEVEL_BUILTINS = {
  ...
  plotshape: (it, p, n, node) => {
    ...
    const style = pineShapeStyleFromConst(n.style);
    const location = pineLocationFromConst(n.location);
    const color = n.color !== undefined ? n.color : '#2962ff';
    const textcolor = n.textcolor !== undefined ? n.textcolor : '#ffffff';
  ...
  plotchar: (it, p, n, node) => {
    ...
    const char = n.char !== undefined ? n.char : '•';
    const location = pineLocationFromConst(n.location);
    const color = n.color !== undefined ? n.color : '#2962ff';
    const textcolor = n.textcolor !== undefined ? n.textcolor : '#ffffff';
    const offset = Math.round(pineNum(n.offset != null ? n.offset : 0)) || 0;
